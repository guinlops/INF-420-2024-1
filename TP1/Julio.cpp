...
int main()
{
    ...
    while (1)
    {
        ...
        for (const Tile tile : neutral_tiles)
        {
            ...
            { // GARANTE QUE UMA TILE NEUTRAL NAO SEJA UMA GRAMA
                targetTiles.push_back(tile);
            }
        }

        for (auto &tile : P_Tiles)
        { // Para cada uma das minhas tiles
        ...
        else
        {
            ...
            { // uma vez que todas as acoes foram adicionadas ao vetor:
                cout << *it << ";";
            }
            cout << endl;
        }
